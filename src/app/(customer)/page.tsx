        ...
        <div className="max-w-7xl mx-auto px-4 py-12 md:py-20">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Taste of Africa,<br />Delivered to You
            </h1>
            <p className="text-lg text-gray-200 mb-8">
              Shop authentic African groceries from local stores near you. Fresh produce, traditional spices, and all your favourite foods.
            </p>
      ...
      <section className="py-12 bg-terracotta">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-white/80 mb-8 max-w-xl mx-auto">
            Join thousands of customers enjoying authentic African groceries delivered fresh to their door.
          </p>
          <Link href="/login">
