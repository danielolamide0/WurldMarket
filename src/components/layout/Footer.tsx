    ...
    <footer className="bg-forest-dark text-white hidden md:block">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">AfriMart</span>
            </div>
            <p className="text-gray-300 text-sm">
              Your one-stop shop for authentic African groceries delivered to your door across the UK.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} AfriMart. All rights reserved. Demo version.</p>
        </div>
      </div>
    </footer>
  )
